...
class LaneDetector(Node):
    def __init__(self) -> None:
        ...
        self.output_topic = self.declare_parameter('image_output_topic', '/perception/front_lane_markings').get_parameter_value().string_value
        self.topic_name = self.declare_parameter('image_source_topic', '/sensors/cameras/image_raw').get_parameter_value().string_value
